  ...
  return (
    ...
    >
      ...
      <div className="w-[40%]">
        ...
        <select
          id="branch"
          className="w-full font-light bg-slate-50 border border-slate-200 text-slate-700 sm:text-base py-3 px-4 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-slate-300 focus:border-slate-400 transition duration-200"
